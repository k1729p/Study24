...
<p>
    View the <a href="images/ScreenshotDockerContainers.png">screenshot</a> of the created Docker containers.
                             ScreenshotDockerContainers.png
</p>
<p><img  alt="" src="images/greenCircle.png">
...
<p><img alt="" src="images/greenCircle.png">
    2.1.1. The <b>Official Document</b> endpoints (on Docker and local):
</p>
<ul>
    <li>'http://localhost:8081/api/document/official/rest'</li>
    <li>'http://localhost:9091/api/document/official/rest'</li>
</ul>
<p>
...
<p><img alt="" src="images/greenCircle.png">
    2.1.2. The <b>Restricted Document</b> endpoints (on Docker and local):
</p>
<ul>
    <li>'http://localhost:8081/api/document/restricted/rest'</li>
    <li>'http://localhost:9091/api/document/restricted/rest'</li>
</ul>
<p>
    The controller method:
...
<p><img alt="" src="images/greenCircle.png">
    2.1.3. The <b>Confidential Document</b> endpoints (on Docker and local):
</p>
<ul>
    <li>'http://localhost:8081/api/document/confidential/rest'</li>
    <li>'http://localhost:9091/api/document/confidential/rest'</li>
</ul>
<p>
    The controller method:
...
<p><img alt="" src="images/greenCircle.png">
    2.1.4. The <b>Secret Document</b> endpoints (on Docker and local):
</p>
<ul>
    <li>'http://localhost:8081/api/document/secret/rest'</li>
    <li>'http://localhost:9091/api/document/secret/rest'</li>
</ul>
<p>
    The controller method:
...
<p><img  alt="" src="images/greenCircle.png">
    3.1. View the <a href="images/ScreenshotCurlLocal.png">screenshot</a> of the console log
...
<p>
    ...
    from the endpoint 'http://localhost:9092/api/document/official/html'.
</p>
...
<p>
    ...
    from the endpoint 'http://localhost:9092/api/document/restricted/html'.<br>
</p>
...
<p>
    ...
    from the endpoint 'http://localhost:9092/api/document/confidential/html'.<br>
</p>
...
<p>
    ...
    from the endpoint 'http://localhost:9092/api/document/secret/html'.<br>
</p>
...
<p>
    ...
    from the endpoint 'http://localhost:9092/api/info'.<br>
</p>
...
<p>
    View the <a href="images/ScreenshotUnrestrictedAccess.png">screenshot</a> of the result
    from the endpoint 'http://localhost:9092/unrestricted'.<br>
</p>
